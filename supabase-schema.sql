create table if not exists public.queue_settings (
  ...
  billing_contract_link text not null default 'assets/contracts/Contrato_Anual_FILA_AI.docx',
...
alter table public.queue_settings
  ...
  add column if not exists billing_contract_link text not null default 'assets/contracts/Contrato_Anual_FILA_AI.docx';
...
create table if not exists public.queue_companies (
  ...
  fiscal_city text not null default '',
  fiscal_state text not null default '',
...
alter table public.queue_companies
  ...
  add column if not exists company_document text not null default '',
  add column if not exists fiscal_address text not null default '',
  add column if not exists fiscal_city text not null default '',
  add column if not exists fiscal_state text not null default '',
...
set billing_contract_link = 'assets/contracts/Contrato_Anual_FILA_AI.docx'
where billing_contract_link = 'https://api.whatsapp.com/send?phone=5511943678179&text=Quero%20assinar%20o%20contrato%20anual%20do%20FILA%20AI';
